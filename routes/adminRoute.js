...
const admin_route = express(); // Use Router() instead of an app instance
...
admin_route.post('/listCategory',adminAuth.isLogin,categoryController.listCategory);
admin_route.post('/unlistCategory',adminAuth.isLogin,categoryController.unlistCategory);
...
admin_route.post('/editBrands',adminAuth.isLogin,brandController.updateBrands);
